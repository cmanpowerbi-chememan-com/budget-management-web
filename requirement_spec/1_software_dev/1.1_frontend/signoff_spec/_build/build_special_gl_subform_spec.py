...
def build_body(meta, rids):
    ...
    P.append(para(run("GL กลุ่มพิเศษมาถึงตารางได้ 2 ทาง — ทั้งคู่เข้าฟอร์มย่อยอัตโนมัติ:",
    ...
    P.append(body_para("GL ภายนอก (รหัสลงท้าย 900030 เช่น 6211900030 ค่าเลี้ยงรับรองภายนอก): ตัวเลือก 4 แบบ", sz=21))
