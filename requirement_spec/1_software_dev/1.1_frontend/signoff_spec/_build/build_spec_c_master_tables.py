...
def build_body(logo_rid, logo_size):
    ...
    p.append(body_para(
        ...
        "(GL Group) เพื่อจัดหมวดหมู่รายการบัญชีในรายงานงบประมาณ"
    ))
    ...
    p.append(body_para(
        ...
        "วันปิดรับไม่ตายตัวและเปลี่ยนแปลงได้ทุกปีตามแผนการจัดทำงบประมาณ"
    ))
    p.append(subheading("ไฟล์ Excel"))
    ...
    p.append(body_para(
        ...
        "และอ้างอิงหน่วยงานในรายงานงบประมาณ"
    ))
    p.append(body_para(
    ...
    p.append(bullet(
        "Cost Center ที่ไม่มีผู้กรอกเลย (เว้นช่องอีเมลว่าง) จะไม่ถูกซิงค์เข้าระบบสิทธิ์ จึงไม่ปรากฏ "
        "บนหน้ากรอกงบของผู้ใช้ทั่วไป — ไม่มีใครเห็นหรือกรอกได้ และงบของ Cost Center นั้นจะว่างไว้ "
        "จนกว่าผู้ดูแลระบบจะเติมอีเมลผู้กรอกลงในแถวนั้น (ผู้ดูแลระบบยังเห็น Cost Center ดังกล่าวได้ "
        "จากสิทธิ์เห็นทุก Cost Center และแก้ไขงบได้โดยตรงหากจำเป็น)"))
    p.append(bullet(
    ...
    p.append(bullet(
        ...
        "(ตัวอย่าง: ไฟล์มี 200 แถว มี 3 แถวที่เว้นช่องผู้กรอกว่าง → ระบบซิงค์ 197 แถว "
        "และข้าม 3 แถวนั้นไป จนกว่าจะเติมอีเมลผู้กรอกให้ครบ)"))
    # ==================================================================== #
    # Sign-off
    # ==================================================================== #
