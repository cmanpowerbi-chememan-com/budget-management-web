...
HUMAN_REQUIRED = [
    ("UAT-49", "เหลืออย่างเดียว: เปิดอีเมล 'ได้รับการอนุมัติ' (03:22) บนมือถือ 1 ครั้ง แล้วยืนยันว่าอักษรไทยไม่เพี้ยนและอยู่ Inbox ของพรทิพย์ — ข้ออื่นทั้งหมด AI ตรวจแล้วผ่าน"),
]
