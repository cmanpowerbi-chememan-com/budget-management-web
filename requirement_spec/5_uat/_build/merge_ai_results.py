...
HUMAN_REQUIRED = [
    ("UAT-15, UAT-42 ข้อ 2-4, UAT-44, UAT-45", "ต้องเปิด toggle โหมด Admin — AI ถูกบล็อกไม่ให้ทำ (นิภาพร/วราพร ทำเอง)"),
    ("UAT-05", "รอ session หมดอายุ 1 ชั่วโมงแล้วล็อกอินใหม่ด้วยบัญชีจริง (ข้อความในกล่องเขียน '14 ชั่วโมง' ตายตัว — ดู UAT-04)"),
    ("UAT-46, UAT-47, UAT-48, UAT-49, UAT-50", "เปิดกล่องจดหมายจริงของลัดดาวัลย์ / นิภาพร / วราพร / พรทิพย์ เทียบเวลาและเนื้อหาอีเมล (เวลากดจริงจดไว้ใน Actual Result แล้ว)"),
    ("UAT-08, UAT-11, UAT-19, UAT-29, UAT-54", "เป็นความเห็นของคน (อ่านเข้าใจไหม / เหมาะสมไหม) — AI เก็บหลักฐานไว้ให้ ยังไม่ตัดสิน"),
    ("UAT-51", "สี/ความชัดที่ 1920×1080 และ 1366×768 บน Chrome + Edge — AI ถ่ายภาพที่ 1400×1000 เท่านั้น"),
    ("UAT-52 ข้อ 2", "ตัดสินว่าการที่ช่องวันเดินทางเปลี่ยน -3 เป็น 3 เงียบ ๆ (ไม่มีข้อความ) รับได้หรือเปิด defect"),
    ("UAT-13", "AI ให้ Fail: ระบบแจ้งข้อความตรวจสอบทีละ 1 ข้อ ไม่ใช่พร้อมกัน — ทีมตัดสินว่าเป็น defect หรือ by design แล้วใส่ Severity/Defect ID"),
]
