...
class TestListHandler:
    ...
    @patch("modules.orgcode_costcenter.list_handler.fetchall")
    @patch("modules.orgcode_costcenter.list_handler.authenticate")
...
class TestSaveHandler:
    ...
    @patch("modules.orgcode_costcenter.save_handler.execute")
    @patch("modules.orgcode_costcenter.save_handler.exists")
    @patch("modules.orgcode_costcenter.save_handler.authenticate")
    def test_happy_path_insert_returns_200_success(
        ...
        from modules.orgcode_costcenter import save_handler
        mock_auth.return_value = admin_claims
...
class TestDeleteHandler:
    ...
    @patch("modules.orgcode_costcenter.delete_handler.execute")
    @patch("modules.orgcode_costcenter.delete_handler.authenticate")
    def test_happy_path_returns_200_with_echoed_keys(
        ...
        from modules.orgcode_costcenter import delete_handler
        mock_auth.return_value = admin_claims
        mock_execute.return_value = None
...
class TestReferenceHandler:
    ...
    @patch("modules.orgcode_costcenter.reference_handler.fetchall")
    @patch("modules.orgcode_costcenter.reference_handler.authenticate")
    ...
    @patch("modules.orgcode_costcenter.reference_handler.fetchall_lakehouse")
    @patch("modules.orgcode_costcenter.reference_handler.authenticate")
    ...
    def test_orgcodes_ref_does_not_call_fetchall_lakehouse(
        ...
        with patch("modules.orgcode_costcenter.reference_handler.fetchall_lakehouse") as mock_lh:
            req = make_request(route_params={"ref_name": "orgcodes"})
            reference_handler.handle(req)
