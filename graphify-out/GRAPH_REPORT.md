...
Cohesion: 0.22
Nodes (8): _allowed_emails(), authenticate(), SWA principal header auth with email allowlist.  Reads ADMIN_EMAILS env var (com, Read SWA-injected headers, check email allowlist. Raise AuthError on failure., HttpRequest, HttpResponse, handle(), POST /api/master/orgcode-costcenter/save
...
- **Why does `execute()` connect `Community 0` to `Community 21`, `Community 15`?**
