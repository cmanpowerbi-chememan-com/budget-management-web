...
## Summary
- 806 nodes · 1475 edges · 62 communities (52 shown, 10 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 92 edges (avg confidence: 0.65)
...
4. `run()` - 16 edges
5. `run()` - 15 edges
6. `build_body()` - 15 edges
7. `build_body()` - 14 edges
8. `execute()` - 13 edges
9. `para()` - 13 edges
10. `PDF` - 13 edges
...
Cohesion: 0.40
Nodes (4): HttpRequest, HttpResponse, handle(), GET /api/master/gl-group/reference/{ref_name}  Serves reference dropdown data so
...
- **Why does `AuthError` connect `Community 24` to `Community 0`, `Community 33`, `Community 1`, `Community 35`, `Community 36`, `Community 37`, `Community 17`, `Community 19`, `Community 22`, `Community 23`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `authenticate()` connect `Community 23` to `Community 0`, `Community 35`, `Community 36`, `Community 37`, `Community 17`, `Community 22`, `Community 24`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `execute()` connect `Community 0` to `Community 17`?**
